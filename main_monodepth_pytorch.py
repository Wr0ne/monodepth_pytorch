...
def return_arguments():
    ...
    parser.add_argument('data_dir', # 数据文件路径
    ...
    parser.add_argument('val_data_dir', # 验证集数据
                        help='path to the validation dataset folder. \
                            It should contain subfolders with following structure:\
                            "image_02/data" for left images and \
                            "image_03/data" for right images'
                        )
    parser.add_argument('model_path', help='path to the trained model') # 模型路径，传递预训练权重？
    parser.add_argument('output_directory', # 输出文件夹，保存测试图片视差
    ...
    parser.add_argument('--input_width', type=int, help='input width',
                        default=512)
    # 模型的选择，默认是 resnet18_md
    parser.add_argument('--model', default='MonodepthModel',
    ...
    # 不用预训练时， 建议设置为 1e-2 (默认1e-4)
    parser.add_argument('--learning_rate', default=1e-2,
                        help='initial learning rate (default: 1e-4)')
    # 3090 batch_size = 16 默认256
